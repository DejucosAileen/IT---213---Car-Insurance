...
// Event Listeners
    ...
    function eventListeners() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if(make === '' || year === '' || level === '') {
                ...
                const price = insurance.calculateQuoatation(insurance);
    ...
    Insurance.prototype.calculateQuoatation = function(insurance) {
        let price;
        const base = 2000;
    ...
    // Check the year cost of the insurance is going to be cheaper
    ...
    Insurance.prototype.calculatelevel = function(price, level) {
       ...
       // Prints the result from the HTML
